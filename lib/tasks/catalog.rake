      ...
      catalog_hash = [
        ...
        { # Мебель для кухни
          ...
          things: [
            ...
            { ru: 'Диван для кухни (прямой)',  en: 'Kitchen sofa (straight)', uk: 'Кухонний диван (прямий)',  he: 'Диван для кухни (прямой)' },
            { ru: 'Диван для кухни (угловой)', en: 'Kitchen sofa (corner)',   uk: 'Кухонний диван (кутовий)', he: 'Диван для кухни (угловой)' },
        ...
        { # Мягкая мебель
          name: { ru: 'Мягкая мебель', en: 'Upholstered furniture', uk: "М'які меблі", he: 'Мягкая мебель',
                  category: 'furniture' },
          things: [
            { ru: 'Диван прямой (двухместный)', en: 'Sofa straight (double)',     uk: 'Прямий диван (двомісний)', he: 'Диван прямой (двухместный)' },
            { ru: 'Диван прямой (трехместный)', en: 'Sofa straight (triple)',     uk: 'Прямий диван (тримісний)', he: 'Диван прямой (трехместный)' },
            { ru: 'Диван угловой',              en: 'Sofa corner',                uk: 'Кутовий диван',            he: 'Диван угловой' },
            { ru: 'Диван модульный',            en: 'Sofa modular',               uk: 'Модульний диван',          he: 'Диван модульный' },

      ...
      catalog_hash = [
        ...
        { # Мебель для кухни
          ...
          things: [
            ...
            { ru: 'Диван для кухни(прямой)',  en: 'Kitchen sofa(straight)', uk: 'Кухонний диван(прямий)',  he: 'Диваны для кухни' },
            { ru: 'Диван для кухни(угловой)', en: 'Kitchen sofa(corner)',   uk: 'Кухонний диван(кутовий)', he: 'Диваны для кухни' },
        ...
        { # Мягкая мебель
          name: { ru: 'Мягкая мебель', en: 'Upholstered furniture', uk: "М'які меблі", he: 'Мягкая мебель',
                  category: 'furniture' },
          things: [
            { ru: 'Диван прямой(двухместный)', en: 'Sofa straight(double)',     uk: 'Прямий диван(двомісний)', he: 'Диваны' },
            { ru: 'Диван прямой(трехместный)', en: 'Sofa straight(triple)',     uk: 'Прямий диван(тримісний)', he: 'Диваны' },
            { ru: 'Диван угловой',             en: 'Sofa corner',               uk: 'Кутовий диван',           he: 'Диваны' },
            { ru: 'Диван модульный',           en: 'Sofa modular',              uk: 'Модульний диван',         he: 'Диваны' },
        ...
        { # Предметы интерьера
          ...
          things: [
            ...
            { ru: 'Стеллаж',            en: 'Rack',            uk: 'Стелаж',          he: 'Вешалки' },

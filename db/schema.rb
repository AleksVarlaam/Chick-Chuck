...
ActiveRecord::Schema[7.0].define(version: 20_230_729_150_612) do
  ...
  create_table 'active_analytics_views_per_days', force: :cascade do |t|
    ...
    t.index %w[referrer_host referrer_path date],
            name: 'index_active_analytics_views_per_days_on_referrer_and_date'
    t.index %w[site page date], name: 'index_active_analytics_views_per_days_on_site_and_date'
  end
  ...
  create_table 'favorites', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[favorited_type favorited_id], name: 'index_favorites_on_favorited'
